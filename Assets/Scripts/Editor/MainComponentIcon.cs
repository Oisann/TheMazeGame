...
class MainComponentIcon {
    ...
    static Type[] componentTypes = new Type[] {
        ...
        // must add specific custom types here if showAllTypes is false but you want to see them
        typeof(MazeManager),
        typeof(ControlledMazeManager),
    };
    static bool showActiveToggle = false;
    static bool showIndentedActiveToggle = true;
    static bool showAllTypes = true;
    static bool useFallbackIconForExcludedComponents = true;
    ...
    static bool alwaysShowCustom = true; // will show all custom, even if they don't have custom images (will show the little script page icon)
    ...
    static void HierarchyItemCB(int instanceID, Rect selectionRect) {
        ...
        if(obj) {
			...
			if (showActiveToggle) {
				...
				if (toggleActiveAllChildInheritToggleObject) {
            ...
            if(components != null) {
                ...
                if(components.Length > 1) {
                    ...
                    if(image == null) {
                        ...
                        image = AssetDatabase.LoadAssetAtPath("Assets/Resources/Sprites/Script Icons/" + type.ToString() + ".png", typeof(Texture)) as Texture;
                    }
    ...
    public static void FetchAllChildGameObjects(Transform transform) {
        ...
        foreach(Transform t in transform) {
            if(!allChildGOsForToggle.Contains(t.gameObject))
                allChildGOsForToggle.Add(t.gameObject);
